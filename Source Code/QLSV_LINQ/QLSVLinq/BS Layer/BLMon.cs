...
namespace QLSVLinq.BS_Layer
{
    class BLMon
    {
        ...
        public bool ThemMon(string MaMon, string TenMon, string MaKhoa, int SoTinChi, string HK)
        {
            try
            {
                QLSVDataContext qlSV = new QLSVDataContext();
        ...
        public bool CapNhatMon(string MaMon, string TenMon, string MaKhoa, int SoTinChi, string HK)
        {
            try
            {
                QLSVDataContext qlSV = new QLSVDataContext();
