...
namespace QLSVLinq.BS_Layer
{
    class BLSV
    {
        ...
        public bool ThemSinhVien(string MaSV, string HoTen, DateTime NgaySinh, string GioiTinh, string DiaChi, string MaLop)
        {
            try
            {
                QLSVDataContext qlSV = new QLSVDataContext();
        ...
        public bool CapNhatSinhVien(string MaSV, string HoTen, DateTime NgaySinh, string GioiTinh, string DiaChi, string MaLop)
        {
            try
            {
                QLSVDataContext qlSV = new QLSVDataContext();
