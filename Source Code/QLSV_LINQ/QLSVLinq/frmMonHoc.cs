        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Add)
            {
                try
                {
                    ...
                    blMon.ThemMon(this.txtMaMon.Text, this.txtTenMon.Text, this.cboKhoa.Text, int.Parse(this.txtSTC.Text), this.txtHocKy.Text);
            ...
            else
            {
                // Thực hiện lệnh 
                BLMon blMon = new BLMon();
                blMon.CapNhatMon(this.txtMaMon.Text, this.txtTenMon.Text, this.cboKhoa.Text, int.Parse(this.txtSTC.Text), this.txtHocKy.Text);
                // Load lại dữ liệu trên DataGridView 
                LoadData();
                // Thông báo 
