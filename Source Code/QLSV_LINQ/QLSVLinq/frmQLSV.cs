        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Add)
            {
                try
                {
                    // Thực hiện lệnh 
                    BLSV blSV = new BLSV();
                    blSV.ThemSinhVien(this.txtMaSV.Text, this.txtHoTen.Text, this.dtpNS.Value, rdbNam.Checked ? "Nam" : "Nữ", this.txtDiaChi.Text, this.cboMalop.Text);
            ...
            else
            {
                // Thực hiện lệnh 
                BLSV blSV = new BLSV();
                blSV.CapNhatSinhVien(this.txtMaSV.Text, this.txtHoTen.Text, this.dtpNS.Value, rdbNam.Checked ? "Nam" : "Nữ", this.txtDiaChi.Text, this.cboMalop.Text);
                // Load lại dữ liệu trên DataGridView 
                LoadData();
                // Thông báo 
